...
(function () {
  ...
  css.textContent = '#evaAuth{position:fixed;inset:0;z-index:100000;display:flex;align-items:center;justify-content:center;padding:22px;background:#11203f;font-family:Pretendard,system-ui,sans-serif;overflow-y:auto}#evaAuth .box{width:min(400px,100%);max-height:calc(100dvh - 44px);overflow-y:auto;box-sizing:border-box;background:#fff;border-radius:22px;padding:30px;box-shadow:0 24px 70px rgba(0,0,0,.35)}#evaAuth h2{margin:0 0 4px;color:#11203f;font-size:22px;letter-spacing:-.04em;line-height:1.25;word-break:keep-all}#evaAuth p{margin:0 0 18px;color:#6b7280;font-size:13px;line-height:1.6;word-break:keep-all}#evaAuth label{display:block;font-size:12px;font-weight:800;color:#54607a;margin:12px 0 5px}#evaAuth input{width:100%;box-sizing:border-box;border:1px solid #e3ddd0;border-radius:11px;padding:11px;font:inherit;font-size:14px;outline:0}#evaAuth input:focus{border-color:#11203f}#evaAuth .row{display:flex;gap:8px;margin-top:16px}#evaAuth button{flex:1;min-height:44px;border:0;border-radius:12px;font:inherit;font-size:14px;font-weight:900;cursor:pointer;white-space:normal}#evaAuth .pri{background:#11203f;color:#fff}#evaAuth .sec{background:#e8714e;color:#fff}#evaAuth .msg{margin-top:14px;font-size:13px;line-height:1.6;padding:11px;border-radius:11px;background:#fbf8f1;color:#54607a;white-space:pre-wrap}@media(max-width:420px){#evaAuth{align-items:flex-start;padding:12px}#evaAuth .box{max-height:calc(100dvh - 24px);border-radius:18px;padding:22px 18px}#evaAuth h2{font-size:20px;letter-spacing:-.025em}#evaAuth .row{flex-direction:column}#evaAuth button{width:100%}}';
